...
- [ ] **04.6** Each of the 14 Base UI migrations: component renders identically on `/design` (light+dark), primary consumer flow works (e.g. dialog open/close/esc/overlay, select keyboard nav, dropdown submenu, switch `sm`)
