...
async function ProjectOverviewContent({ params }: PageProps) {
...
export default function ProjectOverviewRoute({ params }: PageProps) {
  return (
    <Suspense fallback={<ProjectOverviewFallback />}>
      <ProjectOverviewContent params={params} />
    </Suspense>
  )
}
